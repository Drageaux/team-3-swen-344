...
export class ClassroomsComponent implements OnInit {
  ...
  constructor(private reservationsService: ReservationsService) {
    // create mock data
    let class0 = new Classroom(1,200,"GOL-1400","A large auditorium.");//0, "Class-0", "OPEN", 0, 30, "GOL-1400");
    let class1 = new Classroom(2,30,"GAN-1337","An art studio.");//1, "Class-1", "UNAVAILABLE", 12, 30, "GAN-1337");
    let class2 = new Classroom(3,40,"GOS-2550", "Chemisty lab.");//2, "Class-2", "RESERVED", 10, 20, "GOS-2550");
